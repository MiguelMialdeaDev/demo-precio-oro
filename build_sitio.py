...
section.bloque { padding: var(--space-2xl) 0; }
...
/* inicio */
.hero { display: grid; gap: var(--space-xl); align-items: center; padding: var(--space-2xl) 0; }
...
/* producto */
.producto { display: grid; gap: var(--space-xl); padding: var(--space-2xl) 0; }
